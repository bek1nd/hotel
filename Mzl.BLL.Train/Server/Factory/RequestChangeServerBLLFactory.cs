...
{
 public   class RequestChangeServerBLLFactory : IRequestChangeServerBLLFactory
    {
        public IRequestChangeServerBLL<TraRequestChangeResponseModel> CreateBllObj()
        {
        ...
        public IRequestChangeServerBLL<TraRequestChangeResponseModel> CreateSampleBllObj()
        {
            return new RequestChangeServerBLL();
        }
    }
}
