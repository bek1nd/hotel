...
{
  public  class OrderConfirmServerBLLFactoty : IOrderConfirmServerBLLFactoty
    {
        public IOrderConfirmServerBLL<TraOrderConfirmResponseModel> CreateBllObj()
        {
        ...
        public IOrderConfirmServerBLL<TraOrderConfirmResponseModel> CreateSampleBllObj()
        {
            return new OrderConfirmServerBLL();
        }
