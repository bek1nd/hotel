...
{
  public  class RequestCancelServerBLLFactory : IRequestCancelServerBLLFactory
    {
        public IRequestCancelServerBLL<TraRequestCancelResponseModel> CreateBllObj()
        {
        ...
        public IRequestCancelServerBLL<TraRequestCancelResponseModel> CreateSampleBllObj()
        {
            return new RequestCancelServerBLL();
        }
    }
}
