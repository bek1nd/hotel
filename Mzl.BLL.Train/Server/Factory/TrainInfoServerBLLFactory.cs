...
{
  public  class TrainInfoServerBLLFactory : ITrainInfoServerBLLFactory
    {
        public ITrainInfoServerBLL<List<TraTrainInfoResponseDateDetailModel>> CreateBllObj()
        {
        ...
        public ITrainInfoServerBLL<List<TraTrainInfoResponseDateDetailModel>> CreateSampleBllObj()
        {
            return new TrainInfoServerBLL();
        }
    }
}
