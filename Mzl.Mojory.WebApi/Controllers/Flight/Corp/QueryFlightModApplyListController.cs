...
namespace Mzl.Mojory.WebApi.Controllers.Flight.Corp
{
    ...
    /// 查询机票改签申请列表
    /// </summary>
    public class QueryFlightModApplyListController : ApiController
    {
        private readonly IQueryFlightModApplyListApplication _queryFlightModApplyListApplication;

        public QueryFlightModApplyListController(IQueryFlightModApplyListApplication queryFlightModApplyListApplication)
        {
            _queryFlightModApplyListApplication = queryFlightModApplyListApplication;
        }
        ...
        private System.IO.Stream ExcelStream(List<FltModApplyListDataViewModel> orderList)
        {
            ...
            ISheet sheet1 = hssfworkbook.CreateSheet("国内机票改签");
