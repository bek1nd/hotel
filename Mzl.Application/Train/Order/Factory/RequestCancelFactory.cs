...
{
  public  class RequestCancelFactory : IServerDomainFactory
    {
        public IServerDomain CreateDomainObj()
        {
            //业务(占位)单元工厂，创建业务单元，通过构造注入到Domain中
            IRequestCancelServerBLLFactory holdSeatServerBllFactory = new RequestCancelServerBLLFactory();
            IRequestCancelServerBLL<TraRequestCancelResponseModel> holdSeatServer = holdSeatServerBllFactory.CreateSampleBllObj();
