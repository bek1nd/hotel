...
{
    internal class SendAuditOrderCancelMessageServiceBll: BaseServiceBll,ISendAuditOrderCancelMessageServiceBll
    {
        private readonly SendAppMessageFactory _sendAppMessageFactory;
        public SendAuditOrderCancelMessageServiceBll(ISendAppMessageDal sendAppMessageDal,
        ...
        {
            return _sendAppMessageFactory.GetSendAppMessage(SendAppMessageTypeEnum.AuditOrderDeleteNotice);
        }

        public void Send(List<SendAppMessageModel> sendAppMessageModels)
        {
            _sendAppMessageFactory.SendAppMessage(sendAppMessageModels, SendAppMessageTypeEnum.AuditOrderDeleteNotice);
        }
    }
}
